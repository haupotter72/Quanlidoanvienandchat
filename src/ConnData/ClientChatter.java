...
public class ClientChatter extends JFrame {
    ...
    public ClientChatter(String text) {
    }
    ...
    public ClientChatter() {
        ...
        panel.setBorder(new TitledBorder(null, "Staff and server infor.", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        JLabel lblNewLabel_1 = new JLabel(" Mgn IP: ");
        ...
        btnConnect.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if(mngSocket !=null) {
                        ChatPanels p = new ChatPanels(mngSocket, staffName, "Manager");
